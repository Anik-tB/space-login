    ...
    <header class="fixed top-0 left-0 right-0 z-50 bg-white/10 backdrop-blur-xl border-b border-white/20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <!-- User Menu -->
                <div class="flex items-center space-x-4">
                    <a href="my_reports.php" class="btn btn-ghost">
            ...
            <section class="mb-8 animate-on-scroll">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4 animate-fade-in-right">
                        <a href="edit_report.php?id=<?= $reportId ?>" class="btn btn-outline btn-lg btn-animate">
                            <i data-lucide="edit" class="w-5 h-5 mr-2"></i>
                            Edit Report
                        </a>
                        <a href="my_reports.php" class="btn btn-primary btn-lg btn-animate">
                ...
                <div class="space-y-8">
                    ...
                    <section class="animate-on-scroll">
                        <div class="card card-glass card-hover">
                            <div class="card-body">
                                <div class="flex items-center space-x-4 mb-6">
                                    <div class="w-10 h-10 bg-gradient-to-r from-secondary-500 to-secondary-600 rounded-xl flex items-center justify-center animate-scale-in">
                                        <i data-lucide="settings" class="w-5 h-5 text-white"></i>
                                    </div>
                                    <h2 class="heading-3" style="color: var(--text-primary);">Update Status</h2>
                                </div>
                                ...
                                <form method="POST" class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <select name="status" class="form-input mt-2">
                                            ...
                                            <option value="disputed" <?= $report['status'] === 'disputed' ? 'selected' : '' ?>>Disputed</option>
                                        </select>
                                    </div>
                                    <button type="submit" class="btn btn-primary w-full btn-animate">
                        ...
                        <div class="card card-glass card-hover">
                            <div class="card-body">
                                <div class="flex items-center space-x-4 mb-6">
                                    ...
                                    <h2 class="heading-3" style="color: var(--text-primary);">Quick Actions</h2>
                                </div>

                                <div class="space-y-3 stagger-animation">
                                    <a href="edit_report.php?id=<?= $reportId ?>" class="btn btn-outline w-full justify-start btn-animate">
                                        <i data-lucide="edit" class="w-4 h-4 mr-3"></i>
                                        Edit Report
                                    </a>
                                    <a href="dispute_center.php?report_id=<?= $reportId ?>" class="btn btn-outline w-full justify-start btn-animate">
                                        <i data-lucide="alert-triangle" class="w-4 h-4 mr-3"></i>
                                        File Dispute
                                    </a>
                                    <button onclick="window.print()" class="btn btn-outline w-full justify-start btn-animate">
                                        <i data-lucide="printer" class="w-4 h-4 mr-3"></i>
                                        Print Report
                                    </button>
                                    <button onclick="shareReport()" class="btn btn-outline w-full justify-start btn-animate">
                            ...
                            <div class="card-body">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="font-medium" style="color: var(--text-primary);"><?= count($disputes) ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
