...
<body class="min-h-screen font-sans" style="background: var(--bg-primary); color: var(--text-primary);">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <section class="mb-8 animate-slide-up" style="animation-duration: 0.3s;">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                   ...
                   <div class="card card-glass card-hover stats-card enhanced-stats relative" data-stat="reports">
    <!-- Icon container in top-right corner -->
    <div class="absolute top-4 right-4 w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0" style="background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%);">
        <i data-lucide="file-text" class="w-6 h-6 text-white"></i>
        <div class="absolute -top-2 -right-2 w-6 h-6 bg-green-500 rounded-full flex items-center justify-center border-2 border-[#1a1a2e]" style="z-index: 20;">
    ...
    <div class="pr-16">
        ...
        <div class="mt-2 flex items-center space-x-2">
            ...
            <span class="text-xs" style="color: var(--text-tertiary);">75% resolved</span>
                   ...
                   <div class="card card-glass card-hover stats-card enhanced-stats relative" data-stat="alerts">
    <!-- Icon container in top-right corner -->
    <div class="absolute top-4 right-4 w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0" style="background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%);">
        <i data-lucide="bell" class="w-6 h-6 text-white"></i>
        <div class="absolute -top-2 -right-2 w-6 h-6 bg-red-500 rounded-full flex items-center justify-center animate-pulse border-2 border-[#1a1a2e]" style="z-index: 20;">
    ...
    <div class="mt-4 flex items-center justify-between text-sm">
        ...
        <span class="text-xs" style="color: var(--text-tertiary);">in your area</span>
                    ...
                    <div class="card card-glass card-hover stats-card enhanced-stats relative" data-stat="safe-spaces">
    <!-- Icon container in top-right corner -->
    <div class="absolute top-4 right-4 w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0" style="background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%);">
        <i data-lucide="map-pin" class="w-6 h-6 text-white"></i>
        <div class="absolute -top-2 -right-2 w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center border-2 border-[#1a1a2e]" style="z-index: 20;">
            <i data-lucide="navigation" class="w-3 h-3 text-white"></i>
        </div>
    </div>
    ...
    <div class="mt-4 flex items-center justify-between text-sm">
        ...
        <span class="text-xs" style="color: var(--text-tertiary);">within 1km</span>
                    ...
                    <div class="card card-glass card-hover stats-card enhanced-stats relative" data-stat="response-time">
    <!-- Icon container in top-right corner -->
    <div class="absolute top-4 right-4 w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0" style="background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%);">
                            ...
                            <div class="flex items-start justify-between mb-4">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="absolute top-0 right-0 w-6 h-6 bg-red-500 rounded-full flex items-center justify-center">
                            ...
                            <div class="flex items-start justify-between mb-4">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="w-16 h-16 bg-gradient-to-r from-cyan-500 to-teal-600 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-200 card-icon shadow-lg">

                                            <i data-lucide="bell" class="w-8 h-8 text-white"></i>

                                        </div>

                                        <div class="absolute top-0 right-0 w-6 h-6 bg-yellow-500 rounded-full flex items-center justify-center animate-pulse">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="card card-glass card-hover group cursor-pointer animate-on-scroll" onclick="window.location.href='community_groups.php'" data-tooltip="Join neighborhood safety groups">
                        ...
                        <div class="card-body p-5 relative">
                            ...
                            <div class="absolute top-5 left-5 w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200 card-icon">
                                <i data-lucide="users" class="w-6 h-6 text-white"></i>
                            </div>

                            <!-- Status badge in top-right corner -->
                            <div class="absolute top-5 right-5 status-online w-3 h-3 rounded-full"></div>

                            <!-- Content with top padding to avoid icon overlap -->
                            <div class="pt-16">
                    ...
                    <div class="card card-glass card-hover group cursor-pointer animate-on-scroll" onclick="window.location.href='legal_aid.php'" data-tooltip="Find legal aid providers and book consultations">
                        ...
                        <div class="card-body p-5 relative">
                            ...
                            <!-- Icon in top-left corner -->
                            <div class="absolute top-5 left-5 w-12 h-12 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200 card-icon">
                    ...
                    <div class="card card-glass card-hover group cursor-pointer animate-on-scroll" onclick="window.location.href='medical_support.php'" data-tooltip="Find medical providers and psychological support">
                        ...
                        <div class="card-body p-5 relative">
                            ...
                            <!-- Icon in top-left corner -->
                            <div class="absolute top-5 left-5 w-12 h-12 bg-gradient-to-r from-red-500 to-pink-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200 card-icon">
                    ...
                    <div class="card card-glass card-hover group cursor-pointer animate-on-scroll" onclick="window.location.href='safety_education.php'" data-tooltip="Access safety education courses and training modules">
                        ...
                        <div class="card-body p-5 relative">
                            ...
                            <!-- Icon in top-left corner -->
                            <div class="absolute top-5 left-5 w-12 h-12 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200 card-icon">
                    ...
                    <div class="card card-glass card-hover group cursor-pointer animate-on-scroll" onclick="window.location.href='panic_button.php'" data-tooltip="Emergency panic button and SOS system">
                        ...
                        <div class="card-body p-5 relative">
                            ...
                            <!-- Icon in top-left corner -->
                            <div class="absolute top-5 left-5 w-12 h-12 bg-gradient-to-r from-red-500 to-rose-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200 card-icon">
                    ...
                    <div class="card card-glass card-hover group cursor-pointer animate-on-scroll" onclick="window.location.href='walk_with_me.php'" data-tooltip="Share your live location with trusted contacts while walking">
                        ...
                        <div class="card-body p-5 relative">
                            ...
                            <!-- Icon in top-left corner -->
                            <div class="absolute top-5 left-5 w-12 h-12 bg-gradient-to-r from-blue-500 to-cyan-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200 card-icon">
                    ...
                    <div class="card card-glass card-hover group cursor-pointer animate-on-scroll" onclick="window.location.href='safe_space_nearby.php'" data-tooltip="Find nearby safe locations">
                        ...
                        <div class="card-body p-5 relative">
                            ...
                            <!-- Icon in top-left corner -->
                            <div class="absolute top-5 left-5 w-12 h-12 bg-gradient-to-r from-accent-500 to-accent-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200 card-icon">
                                <i data-lucide="map-pin" class="w-6 h-6 text-white"></i>
                            </div>
                    ...
                    <div class="card card-glass card-hover group cursor-pointer animate-on-scroll" onclick="window.location.href='my_reports.php'" data-tooltip="Manage your incident reports">
                        ...
                        <div class="card-body p-5 relative">
                            ...
                            <!-- Icon in top-left corner -->
                            <div class="absolute top-5 left-5 w-12 h-12 bg-gradient-to-r from-primary-500 to-primary-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200 card-icon">
                    ...
                    <div class="card card-glass card-hover group cursor-pointer animate-on-scroll" onclick="window.location.href='dispute_center.php'" data-tooltip="Appeal false reports">
                        ...
                        <div class="card-body p-5 relative">
                            ...
                            <!-- Icon in top-left corner -->
                            <div class="absolute top-5 left-5 w-12 h-12 bg-gradient-to-r from-secondary-500 to-secondary-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200 card-icon">
                    ...
                    <div class="card card-glass card-hover group cursor-pointer animate-on-scroll" onclick="window.location.href='safety_resources.php'" data-tooltip="Access safety guides and support">
                        ...
                        <div class="card-body p-5 relative">
                            ...
                            <!-- Icon in top-left corner -->
                            <div class="absolute top-5 left-5 w-12 h-12 bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200 card-icon">
                    ...
                    <div class="card card-glass card-hover group cursor-pointer animate-on-scroll" onclick="window.location.href='emergency_services.php'" data-tooltip="Find nearby police, hospitals, and emergency services">
                        ...
                        <div class="card-body p-5 relative">
                            ...
                            <!-- Icon in top-left corner -->
                            <div class="absolute top-5 left-5 w-12 h-12 bg-gradient-to-r from-red-500 to-orange-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200 card-icon">
